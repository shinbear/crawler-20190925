...
public class Runwebdriver_QBOne {
	...
	public static String name_en_last = "";
	public static String name_en_first = "";
	public static String aff_inst_candidate_year = "";
	public static String CAS_candidate_yr = "";
	...
	// search keywords
	public static String[] source_Search_arry = new String[3];
	...
	public static ArrayList<Object> runRecord(ArrayList<Object> recordlist) throws InterruptedException {
		...
		source_Search_arry = (String[]) recordlist.get(7);
		...
		recordlist.add(source_Search_arry);
	...
	public static int searchName(WebDriver webDriver) throws IOException {
		try {
			...
			// Input the author
			String searchQuery = source_Search_arry[0];
						...
						for (int p = 0; p < tc.size(); p++) {
							...
							for (int j = 0; j < td.size(); j++) {
								if (td.get(j).getText().contains("出版年")) {
									...
									// Journal
									try {
										Result[25] = sourceStr.substring(0, sourceStr.indexOf("卷:"))
												.replaceAll("(\\r\\n|\\r|\\n|\\n\\r)", "");
									} catch (Exception e) {
										// TODO Auto-generated catch block
										Result[25] = "";
									...
									try {
										...
										Result[24] = publishYear;
										Result[23] = publishmonth;
									} catch (Exception e) {
										// TODO Auto-generated catch block
										Result[24] = "";
										Result[23] = "";
	...
	public static int getDetail(WebDriver webDriver) throws IOException {
		...
		try {
			...
			try {
				...
				Result[26] = "*" + phaseStr.getText().replaceAll("期:", "");
			} catch (Exception e) {
				Result[26] = " ";
			}
			...
			try {
				...
				Result[27] = strPageArray[0];
				Result[28] = strPageArray[1];
			} catch (Exception e) {
				Result[27] = "";
				Result[28] = "";
			}
			...
			// Being cite of web science
			try {
				// WebElement beingCiteItem =
				// tbb.findElement(By.cssSelector(".search-results-data-cite"));
				WebElement beingCiteItem = webDriver
						.findElement(By.xpath("//*[text()='引用的参考文献']/../preceding-sibling::div[1]"));
				Result[13] = beingCiteItem.getText();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				Result[13] = " ";
				e.printStackTrace();
			...
			if (FRLabelStr.contains("DOI:")) {
				try {
					try {
						Result[29] = webDriver.findElement(By.xpath("//*[text()='DOI:']/following-sibling::value"))
								.getText();
					} catch (Exception e) {
						// TODO Auto-generated catch block
						Result[29] = webDriver.findElement(By.xpath("//*[text()='DOI:']/..")).getText()
								.replaceAll("DOI:", "");
						e.printStackTrace();
					}
				} catch (Exception e) {
			...
			try {
				...
				Result[16] = tbs.get(0).getText();
				Result[17] = tbs.get(1).getText();
			...
			if (FRLabelStr.contains("研究方向:")) {
				try {
					...
					Result[31] = tl.getText().substring(5);
				} catch (Exception e) {
					Result[31] = "";
				}
			}
			...
			if (FRLabelStr.contains("Web of Science 类别:")) {
				try {
					...
					Result[30] = tl.getText().substring(18);
				} catch (Exception e) {
					Result[30] = "";
				}
			}
			...
			if (FRLabelStr.contains("IDS 号:")) {
				try {
					...
					Result[32] = tl.getText().replaceAll("IDS 号", "").replaceAll("(\\r\\n|\\r|\\n|\\n\\r)", "");
				} catch (Exception e) {
					Result[32] = "";
				}
			}
			...
			if (FRLabelStr.contains("PubMed ID:")) {
				try {
					...
					Result[32] = tl.getText().replaceAll("PubMed ID:", "").replaceAll("(\\r\\n|\\r|\\n|\\n\\r)", "");
				} catch (Exception e) {
					Result[32] = "";
				}
			}
			...
			if (FRLabelStr.contains("ISSN:")) {
				try {
					...
					Result[19] = tl.getText().replaceAll("ISSN:", "").replaceAll("(\\r\\n|\\r|\\n|\\n\\r)", "");
				} catch (Exception e) {
					Result[19] = "";
				}
			}
			...
			try {
				WebElement tl;
				try {
					tl = webDriver.findElement(By.xpath("//*[text()='出版商']/.."));

				} catch (Exception e) {
					// TODO Auto-generated catch block
					tl = webDriver.findElement(By.xpath("//*[text()='出版商']/following-sibling::value"));
					e.printStackTrace();
				}
				Result[18] = tl.getText().replaceAll("出版商", "").replaceAll("(\\r\\n|\\r|\\n|\\n\\r)", "");
			} catch (Exception e) {
				Result[18] = "";
			}
			...
			if (FRLabelStr.contains("eISSN:")) {
				try {
					...
					Result[20] = tl.getText().replaceAll("eISSN:", "");
				} catch (Exception e) {
					Result[20] = "";
				}
			}
	...
	public static void writrintExcel() throws IOException {
		// write into excel
		writerIn.println(IDS + "\t" + No + "\t" + ID + "\t" + Name + "\t" + name_en_last + "\t" + name_en_first + "\t"
				+ aff_inst_candidate_year + "\t" + CAS_candidate_yr + "\t" + source_Search_arry[0] + "\t"
				+ source_Search_arry[1] + "\t" + source_Search_arry[2] + "\t" + Result[0] + "\t" + Result[1] + "\t"
	...
	public static void readExcel(Sheet sheet, int rowid) {
		...
		try {
			...
			if ("".equals(cell1.getContents()) != true) {
				...
				No = cell2.getContents().replace('\n', ' ');
				ID = cell3.getContents().replace('\n', ' ');
				Name = cell4.getContents().replace('\n', ' ');
